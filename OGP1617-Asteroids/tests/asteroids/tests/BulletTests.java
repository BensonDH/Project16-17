...
public class BulletTests {
	...
	public void DistanceBetweenTests() {	
		...
		bullet2.setPosition(Bullet.getMinimumRadius()+10, 0);
		assertEquals(0, bullet1.getDistanceBetween(bullet2), EPSILON);
		
		//case 3 bullets are overlapping, negative value expected
		bullet2.setPosition(10, 0);
		assertEquals(-Bullet.getMinimumRadius(), bullet1.getDistanceBetween(bullet2), EPSILON);
	...
	public void terminationTest(){
		Bullet testBullet = new Bullet(100, 100, 0, 0, 10);
		Ship testShip = new Ship(500, 500, 0, 0, 15, 0);
		...
		assertFalse(testShip.getBullets().contains(testBullet));
		
		Bullet testBullet2 = new Bullet(250, 250, 0, 0, 10);
		testWorld.addEntity(testBullet2);
		testShip.loadBullets(testBullet2);
		testShip.fireBullet();
		
		assertTrue(testBullet2.getSourceShip() == testShip);
		testBullet2.die();
		assertTrue(testBullet2.isDead());
		assertNull(testBullet2.getSourceShip());
	}
}
